function precisions = precision_plot(positions, ground_truth, fps, title, show)
%PRECISION_PLOT
...
% 		fprintf('%12s - Number of ground truth frames does not match number of tracked frames.\n', title)
	...
	if show == 1,
        ...
        str = sprintf('%12s - Precision (20px):% 1.3f, FPS:% 4.2f\n', title, precisions(20), fps);
        %legend(str);
        text(15,0.32,str,'Color','red','FontSize',14)
