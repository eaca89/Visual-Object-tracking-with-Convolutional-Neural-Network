...
function [rects, time] = tracker_ensemble(video_path, img_files, pos, target_sz, ...
...
%nweights  = [1, 0.75, 0.5, 0.25, 0.15]; % Weights for combining correlation filter responses
indLayers = [37, 28, 19];
nweights  = [0.02, 1, 0.5];
% nweights  = [1, 0.75, 0.5];
